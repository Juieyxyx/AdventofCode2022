...
public class day17 {
    ...
    public static boolean containsAny(HashSet<Coord> big, HashSet<Coord> small) {
        for(Coord c : small)
            if(big.contains(c))
                return true;
        return false;
    ...
    public static HashSet<Coord> convertToCacheKey(HashSet<Coord> rocks) {
    ...
    public static void main(String[] args) throws IOException {
        File inputFile = new File("AoC2022/inputs/input_day17.txt");
